...
| Name | Description | Platform | Stars |
| --- | --- | --- | --- |
| [UniGetUI](https://github.com/marticliment/UniGetUI) | The Graphical Interface for your package managers.  | ```Windows``` | ![GitHub Repo stars](https://img.shields.io/github/stars/marticliment/UniGetUI?style=for-the-badge&label=%20&color=white) |
